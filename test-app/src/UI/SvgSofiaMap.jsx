const SvgSofiaMap = ({ handleMouseEnter, handleMouseLeave, handleClick, type}) => {
    const create = type || undefined;

return (
    <div className='m-auto max-h-fit max-w-3xl'>
        <svg height='100%' width='100%' xmlns='http://www.w3.org/2000/svg' version='1.1' viewBox='0 80 510 370'>
            <defs id='defs4'>
